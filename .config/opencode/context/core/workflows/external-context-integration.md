...
- Answer is in `/Users/muriloromeo/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/Users/muriloromeo/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md`
