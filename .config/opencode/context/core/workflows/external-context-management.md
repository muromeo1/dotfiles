...
- **Task Delegation**: `/Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md` — How to reference external context in sessions
- **Session Management**: `/Users/muriloromeo/.config/opencode/context/core/workflows/session-management.md` — Session lifecycle
