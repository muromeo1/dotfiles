...
┌──────────────────────────────────────────────────┐
│ STEP 1: ContextScout                             │
│ → Search internal context (/Users/muriloromeo/.config/opencode/context/)  │
...
- Cache useful docs in `/Users/muriloromeo/.config/opencode/context/development/frameworks/` if frequently used
...
**Rule**: If it's not in `/Users/muriloromeo/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `/Users/muriloromeo/.config/opencode/context/` | Internet (Context7, official docs) |
...
- **Code Standards**: `/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md`
