...
|-------|----------|---------|
| `context_files` | **Standards only** — paths to coding conventions, patterns, security rules | `/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md` |
...
├── .cache/
│   ├── test-coverage.md (cached from /Users/muriloromeo/.config/opencode/context/core/standards/test-coverage.md)
│   ├── code-quality.md (cached from /Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md)
│   └── code-review.md (cached from /Users/muriloromeo/.config/opencode/context/core/workflows/code-review.md)
...
```json
{
  ...
  "cache": {
    "test-coverage.md": {
      "source": "/Users/muriloromeo/.config/opencode/context/core/standards/test-coverage.md",
      "cached_at": "2026-01-28T14:30:25Z",
      "used_by": ["subtask_01", "subtask_02", "subtask_03"],
      "status": "valid"
    },
    "code-quality.md": {
      "source": "/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md",
...
IF cache exists AND cache is valid:
  ...
  SKIP re-reading from /Users/muriloromeo/.config/opencode/context/
ELSE:
  READ from /Users/muriloromeo/.config/opencode/context/
  CACHE the file
```
