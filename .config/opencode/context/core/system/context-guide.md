...
**Index Location**: `/Users/muriloromeo/.config/opencode/context/index.md` - Quick map of all contexts
...
**Central Index**: `/Users/muriloromeo/.config/opencode/context/index.md` - Ultra-compact map of all contexts
...
All files are in `/Users/muriloromeo/.config/opencode/context/core/` with organized subfolders:
...
- Load `/Users/muriloromeo/.config/opencode/context/index.md`
...
### /Users/muriloromeo/.config/opencode/context/core/standards/code-analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /Users/muriloromeo/.config/opencode/context/core/workflows/feature-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /Users/muriloromeo/.config/opencode/context/core/workflows/session-management.md
- Session lifecycle
- Cleanup procedures
- Session isolation
