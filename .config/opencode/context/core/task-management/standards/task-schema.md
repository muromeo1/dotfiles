...
|-------|---------|----------|----------------|
| `context_files` | "What rules do I follow?" | Standards, conventions, patterns from `/Users/muriloromeo/.config/opencode/context/` | Load and apply as coding guidelines |
