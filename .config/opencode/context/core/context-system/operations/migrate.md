...
**Purpose**: Copy context files from global (`~/.config/opencode/context/`) to local (`/Users/muriloromeo/.config/opencode/context/`) so they're project-specific and git-committed.
...
Local location: /Users/muriloromeo/.config/opencode/context/
...
If local `/Users/muriloromeo/.config/opencode/context/project-intelligence/` already exists:
...
Will copy to:   /Users/muriloromeo/.config/opencode/context/project-intelligence/
...
**Actions on approval:**
1. Create `/Users/muriloromeo/.config/opencode/context/project-intelligence/` if it doesn't exist
...
Copied 3 files to /Users/muriloromeo/.config/opencode/context/project-intelligence/
...
**Permission denied:**
```
Error: Cannot write to /Users/muriloromeo/.config/opencode/context/project-intelligence/
...
- Context path resolution: `/Users/muriloromeo/.config/opencode/context/core/system/context-paths.md`
