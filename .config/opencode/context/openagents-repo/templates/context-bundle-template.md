...
**Core Standards**:
- `/Users/muriloromeo/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `/Users/muriloromeo/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `/Users/muriloromeo/.config/opencode/context/core/standards/docs.md` → Documentation standards
- `/Users/muriloromeo/.config/opencode/context/core/standards/patterns.md` → Error handling, security patterns

**Core Workflows**:
- `/Users/muriloromeo/.config/opencode/context/core/workflows/delegation.md` → Delegation process
- `/Users/muriloromeo/.config/opencode/context/core/workflows/task-breakdown.md` → Task breakdown methodology
- `/Users/muriloromeo/.config/opencode/context/core/workflows/review.md` → Code review guidelines
