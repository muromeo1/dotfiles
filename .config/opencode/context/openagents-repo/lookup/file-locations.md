...
| **Context files** | `/Users/muriloromeo/.config/opencode/context/` |
...
| **New context** | `/Users/muriloromeo/.config/opencode/context/{category}/{name}.md` |
...
```
/Users/muriloromeo/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md`
- `/Users/muriloromeo/.config/opencode/context/development/frontend/react/react-patterns.md`
- `/Users/muriloromeo/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /Users/muriloromeo/.config/opencode/context/{category}/

# All context
find /Users/muriloromeo/.config/opencode/context -name "*.md"
```
