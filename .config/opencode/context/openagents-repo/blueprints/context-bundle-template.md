...
**Core Standards**:
- `/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md` → Modular, functional code patterns
- `/Users/muriloromeo/.config/opencode/context/core/standards/test-coverage.md` → Testing requirements and TDD
- `/Users/muriloromeo/.config/opencode/context/core/standards/documentation.md` → Documentation standards
- `/Users/muriloromeo/.config/opencode/context/core/standards/security-patterns.md` → Error handling, security patterns

**Core Workflows**:
- `/Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md` → Delegation process
- `/Users/muriloromeo/.config/opencode/context/core/workflows/feature-breakdown.md` → Task breakdown methodology
- `/Users/muriloromeo/.config/opencode/context/core/workflows/code-review.md` → Code review guidelines

## Repository-Specific Context (Load These Before Starting)

**Quick Start** (ALWAYS load first):
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/core-concepts/agents.md` → How agents work
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/core-concepts/evals.md` → How testing works
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/core-concepts/registry.md` → How registry works
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/core-concepts/categories.md` → How organization works

**Guides** (Load for specific workflows):
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/guides/adding-agent.md` → Step-by-step agent creation
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/guides/testing-agent.md` → Testing workflow
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/guides/updating-registry.md` → Registry workflow
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/guides/debugging.md` → Troubleshooting

**Lookup** (Quick reference):
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/lookup/file-locations.md` → Where everything is
- `/Users/muriloromeo/.config/opencode/context/openagents-repo/lookup/commands.md` → Command reference
...
2. **Copy template**:
   ```bash
   cp /Users/muriloromeo/.config/opencode/context/openagents-repo/templates/context-bundle-template.md \
...
See `/Users/muriloromeo/.config/opencode/context/openagents-repo/examples/context-bundle-example.md` for a complete example.
