...
/Users/muriloromeo/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /Users/muriloromeo/.config/opencode/context/{category}
...
```bash
cat > /Users/muriloromeo/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/Users/muriloromeo/.config/opencode/context/{category}/
...
Loads: `/Users/muriloromeo/.config/opencode/context/development/react-patterns.md`
