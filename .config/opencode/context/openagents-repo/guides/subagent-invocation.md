...
glob(pattern="**/*.md", path="/Users/muriloromeo/.config/opencode/context")

// 2. Use grep to search content
grep(pattern="registry", path="/Users/muriloromeo/.config/opencode/context")

// 3. Read relevant files directly
read(filePath="/Users/muriloromeo/.config/opencode/context/openagents-repo/core-concepts/registry.md")
```
