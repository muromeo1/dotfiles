...
Tool Call Details:
  1. glob: {"pattern":"*.md","path":"/Users/muriloromeo/.config/opencode/context/core"}
```
...
prompts:
  - text: |
      List all markdown files in /Users/muriloromeo/.config/opencode/context/core/
```
...
prompts:
  - text: |
      Use the glob tool to find all markdown files in /Users/muriloromeo/.config/opencode/context/core/
      
      You MUST use the glob tool like this:
      glob(pattern="*.md", path="/Users/muriloromeo/.config/opencode/context/core")
