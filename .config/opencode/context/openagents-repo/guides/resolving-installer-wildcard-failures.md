...
```
**Cause**: Wildcard expansion returned context IDs that weren’t path-aligned (e.g., `standards-code` mapped to `/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md`). Installer treated IDs as paths.
