...
**Context** (`/Users/muriloromeo/.config/opencode/context/category/your-context.md`):
```yaml
---
...
```json
{
  ...
  "type": "context",
  "path": "/Users/muriloromeo/.config/opencode/context/core/workflows/session-management.md",
  "aliases": [
    "workflows-sessions",
    "sessions"
  ],
