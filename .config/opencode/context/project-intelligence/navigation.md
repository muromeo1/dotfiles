...
```
/Users/muriloromeo/.config/opencode/context/project-intelligence/
...
- `/Users/muriloromeo/.config/opencode/context/core/standards/project-intelligence.md` (standards and patterns)
- `/Users/muriloromeo/.config/opencode/context/core/system/context-guide.md` (context loading)

See `/Users/muriloromeo/.config/opencode/context/core/context-system.md` for the broader context architecture.
...
**Management Guide**: See `/Users/muriloromeo/.config/opencode/context/core/standards/project-intelligence-management.md` for complete lifecycle management including:
...
See `/Users/muriloromeo/.config/opencode/context/core/standards/project-intelligence.md` for the standard itself.
