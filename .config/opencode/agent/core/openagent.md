...
- Code tasks → /Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md
- Docs tasks → /Users/muriloromeo/.config/opencode/context/core/standards/documentation.md  
- Tests tasks → /Users/muriloromeo/.config/opencode/context/core/standards/test-coverage.md
- Review tasks → /Users/muriloromeo/.config/opencode/context/core/workflows/code-review.md
- Delegation → /Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md
...
<execution_priority>
  ...
  <conflict_resolution>
    ...
    - Context files (/Users/muriloromeo/.config/opencode/context/core/*.md) MANDATORY, not optional
  ...
  <stage id="3" name="Execute" when="approved">
    ...
    <step id="3.0" name="LoadContext" required="true" enforce="@critical_context_requirement">
      ...
      2. Map to context file:
         - code (write/edit code) → Read /Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md NOW
         - docs (write/edit docs) → Read /Users/muriloromeo/.config/opencode/context/core/standards/documentation.md NOW
         - tests (write/edit tests) → Read /Users/muriloromeo/.config/opencode/context/core/standards/test-coverage.md NOW
         - review (code review) → Read /Users/muriloromeo/.config/opencode/context/core/workflows/code-review.md NOW
         - delegate (using task tool) → Read /Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md NOW
      ...
      <automatic_loading>
        IF code task → /Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
        IF docs task → /Users/muriloromeo/.config/opencode/context/core/standards/documentation.md (MANDATORY)
        IF tests task → /Users/muriloromeo/.config/opencode/context/core/standards/test-coverage.md (MANDATORY)
        IF review task → /Users/muriloromeo/.config/opencode/context/core/workflows/code-review.md (MANDATORY)
        IF delegation → /Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md (MANDATORY)
...
<delegation_rules id="delegation_rules">
     ...
     <route to="Specialist" when="simple_specialist_task">
       ...
       <context_pattern>
         ...
         task(
           ...
           prompt="Context to load:
                   - /Users/muriloromeo/.config/opencode/context/core/standards/test-coverage.md
       ...
       <examples>
         ...
         task(
           ...
           prompt="Context to load:
                   - /Users/muriloromeo/.config/opencode/context/core/workflows/code-review.md
         ...
         task(
           ...
           prompt="Context to load:
                   - /Users/muriloromeo/.config/opencode/context/core/standards/documentation.md
  ...
  <process ref="/Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md">Full delegation template & process</process>
</delegation_rules>
...
<static_context>
  Context index: /Users/muriloromeo/.config/opencode/context/index.md
