         ...
         3. Create subtask_NN.json for each task:
             ...
             **AGENT FIELD SEMANTICS**:
              ...
              **FRONTEND RULE**: If a task involves UI design, styling, or frontend implementation:
              ...
              2. Include `/Users/muriloromeo/.config/opencode/context/ui/web/ui-styling-standards.md` and `/Users/muriloromeo/.config/opencode/context/core/workflows/design-iteration.md` in `context_files`.
