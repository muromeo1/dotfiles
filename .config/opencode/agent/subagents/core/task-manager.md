...
BEFORE starting task breakdown, ALWAYS:
  1. Load context: `/Users/muriloromeo/.config/opencode/context/core/task-management/navigation.md`
...
- Tasks without status check → Duplicate work, conflicts
  ...
  <interaction_protocol>
    <with_meta_agent>
      ...
      - Do NOT read `/Users/muriloromeo/.config/opencode/context/core/workflows/task-delegation.md` or follow delegation workflows.
  ...
  <workflow_execution>
    <stage id="0" name="ContextLoading">
      ...
      <process>
        1. Load task management context:
           - `/Users/muriloromeo/.config/opencode/context/core/task-management/navigation.md`
           - `/Users/muriloromeo/.config/opencode/context/core/task-management/standards/task-schema.md`
           - `/Users/muriloromeo/.config/opencode/context/core/task-management/guides/splitting-tasks.md`
           - `/Users/muriloromeo/.config/opencode/context/core/task-management/guides/managing-tasks.md`

        2. Check current task state:
           ```bash
           npx ts-node --compiler-options '{"module":"commonjs"}' /Users/muriloromeo/.config/opencode/context/tasks/scripts/task-cli.ts status
           ```
    ...
    <stage id="2" name="JSONCreation">
      ...
      <process>
        ...
        4. Validate with CLI:
           ```bash
           npx ts-node --compiler-options '{"module":"commonjs"}' /Users/muriloromeo/.config/opencode/context/tasks/scripts/task-cli.ts validate {feature}
           ```
    ...
    <stage id="3" name="Verification">
      ...
      <process>
        ...
        3. If all criteria pass:
           ```bash
           npx ts-node --compiler-options '{"module":"commonjs"}' /Users/muriloromeo/.config/opencode/context/tasks/scripts/task-cli.ts complete {feature} {seq} "{summary}"
           ```
        ...
        5. Check for next task:
           ```bash
           npx ts-node --compiler-options '{"module":"commonjs"}' /Users/muriloromeo/.config/opencode/context/tasks/scripts/task-cli.ts next {feature}
           ```
      </process>
    ...
    <stage id="4" name="Archiving">
      ...
      <process>
        1. Verify all tasks complete:
           ```bash
           npx ts-node --compiler-options '{"module":"commonjs"}' /Users/muriloromeo/.config/opencode/context/tasks/scripts/task-cli.ts status {feature}
           ```
...
Script location: `/Users/muriloromeo/.config/opencode/context/tasks/scripts/task-cli.ts`
</cli_integration>
