...
- @/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md - Code quality standards (REQUIRED)
...
- @/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md - Code quality standards (REQUIRED before write/edit)

**Just-in-time context (load per stage using read tool)**:

**On first design request**:
- Read @/Users/muriloromeo/.config/opencode/context/core/workflows/design-iteration.md to understand the 4-stage workflow

**Stage 1 (Layout)**:
- No additional context needed - use ASCII wireframes

**Stage 2 (Theme)**:
- Read @/Users/muriloromeo/.config/opencode/context/development/design-systems.md for theme patterns
- Read @/Users/muriloromeo/.config/opencode/context/development/ui-styling-standards.md for CSS conventions

**Stage 3 (Animation)**:
- Read @/Users/muriloromeo/.config/opencode/context/development/animation-patterns.md for micro-interaction patterns

**Stage 4 (Implementation)**:
- Read @/Users/muriloromeo/.config/opencode/context/development/design-assets.md for images, icons, CDN resources
...
<examples>
  <example name="Create Landing Page">
    ...
    **Agent**:
    1. Read @/Users/muriloromeo/.config/opencode/context/core/workflows/design-iteration.md to understand workflow
