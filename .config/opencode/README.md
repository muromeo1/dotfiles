...
**The AOC solution:** Store team patterns in `/Users/muriloromeo/.config/opencode/context/project/`. Commit to repo. Everyone uses same standards.
...
# Commit to repo
git add /Users/muriloromeo/.config/opencode/context/
...
Store patterns in `/Users/muriloromeo/.config/opencode/context/project/`. Commit to repo. Entire team uses same standards. New developers inherit patterns automatically.
...
```
1. Check local: /Users/muriloromeo/.config/opencode/context/core/navigation.md
...
- **Project intelligence is always local** — your tech stack, patterns, and naming conventions live in `/Users/muriloromeo/.config/opencode/context/project-intelligence/` and are never loaded from global
...
|-------|----------------|--------------------------|
| Local install (`bash install.sh developer`) | `/Users/muriloromeo/.config/opencode/context/core/` | `/Users/muriloromeo/.config/opencode/context/project-intelligence/` |
| Global install + `/add-context` | `~/.config/opencode/context/core/` | `/Users/muriloromeo/.config/opencode/context/project-intelligence/` |
| Both local and global | `/Users/muriloromeo/.config/opencode/context/core/` (local wins) | `/Users/muriloromeo/.config/opencode/context/project-intelligence/` |
...
A: Commit `/Users/muriloromeo/.config/opencode/context/project/` to your repo. Team members automatically use same patterns.
