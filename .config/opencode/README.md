...
cp -r /Users/muriloromeo/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/Users/muriloromeo/.config/opencode/context/` to follow your coding standards.
...
nano ~//Users/muriloromeo/.config/opencode/context/project/project-context.md
...
A: Edit `~//Users/muriloromeo/.config/opencode/context/project/project-context.md` - agents automatically load this file.
