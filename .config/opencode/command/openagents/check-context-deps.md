...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/Users/muriloromeo/.config/opencode/context/` (direct path references)
    - `@/Users/muriloromeo/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/Users/muriloromeo/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/Users/muriloromeo/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/Users/muriloromeo/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/Users/muriloromeo/.config/opencode/context/core/" (direct paths)
       - "@/Users/muriloromeo/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /Users/muriloromeo/.config/opencode/context/core/:
...
✓ /Users/muriloromeo/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /Users/muriloromeo/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/Users/muriloromeo/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
