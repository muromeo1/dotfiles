...
**What happens**:
1. Saves to `/Users/muriloromeo/.config/opencode/context/project-intelligence/` in your project (always local)
...
**Default behavior**: Always use local `/Users/muriloromeo/.config/opencode/context/project-intelligence/`.
...
2. Otherwise → `$CONTEXT_DIR = /Users/muriloromeo/.config/opencode/context/project-intelligence/` (always local)

**If `/Users/muriloromeo/.config/opencode/context/` doesn't exist yet**, create it silently — no prompt needed. The directory structure is part of the output shown in Stage 4.
...
Check: `$CONTEXT_DIR` (set in Stage 0.5 — either `/Users/muriloromeo/.config/opencode/context/project-intelligence/` or `~/.config/opencode/context/project-intelligence/`)
...
- Project Intelligence: /Users/muriloromeo/.config/opencode/context/core/standards/project-intelligence.md
- MVI Principles: /Users/muriloromeo/.config/opencode/context/core/context-system/standards/mvi.md
...
A: `cat /Users/muriloromeo/.config/opencode/context/project-intelligence/technical-domain.md` (local) or `cat ~/.config/opencode/context/project-intelligence/technical-domain.md` (global)

**Q: Multiple context files?**
A: Yes! Create in your project-intelligence directory. Agents load all.

**Q: Remove pattern?**
A: Edit directly: `nano /Users/muriloromeo/.config/opencode/context/project-intelligence/technical-domain.md`

**Q: Share w/ team?**
A: Yes! Use local install (`/Users/muriloromeo/.config/opencode/context/project-intelligence/`) and commit to repo. Team members get your patterns automatically.
...
A: Run `/add-context` (defaults to local). Creates `/Users/muriloromeo/.config/opencode/context/project-intelligence/` in your project even if OAC was installed globally.
