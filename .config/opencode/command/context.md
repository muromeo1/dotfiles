...
<critical_rules priority="absolute" enforcement="strict">
  ...
  <rule id="lazy_load">
    ALWAYS read required context files from /Users/muriloromeo/.config/opencode/context/core/context-system/ BEFORE executing operations.
  </rule>
</critical_rules>
...
**`/context migrate`**
- Copy project-intelligence from global (`~/.config/opencode/context/`) to local (`/Users/muriloromeo/.config/opencode/context/`)
...
**All files located in**: `/Users/muriloromeo/.config/opencode/context/core/context-system/`
...
<subagent_routing>
  ...
  <route operations="harvest|extract|organize|update|error|create|migrate" to="ContextOrganizer">
    ...
    Subagent loads: Required context files from /Users/muriloromeo/.config/opencode/context/core/context-system/
...
### Structure
```
/Users/muriloromeo/.config/opencode/context/core/context-system/
...
```bash
/context migrate
# Copies project-intelligence from ~/.config/opencode/context/ to /Users/muriloromeo/.config/opencode/context/
...
**Context System Location**: `/Users/muriloromeo/.config/opencode/context/core/context-system/`
